...
<head>
  ...
  <title>Appointments | Chief Officer</title>
  <link rel="stylesheet" href="css/index.css">
  <link rel="stylesheet" href="css/Appoiments.css">
...
<div class="app-container">
  <!-- Sidebar (same ids/classes style as your other pages) -->
  <aside class="sidebar">
  ...
  <main class="main-content">
    <header class="header">
      ...
      <div class="header-right">
        <div class="header-actions">
          ...
          <button class="btn btn-primary" id="addAppointmentBtn" type="button">
    ...
    <div class="content">
      <!-- Stats cards (IDs we create — won’t affect your CSS) -->
